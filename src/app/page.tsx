...
export default function BookingPage() {
  ...
  const onSubmit: SubmitHandler<BookingFormData> = async (data) => {
    ...
    // Prepare the core data, excluding fields that will be generated by Firebase backend/context
    const bookingCoreData = {
      ...
      date: selectedDate, // Will be converted to Timestamp in context
      startTime: selectedTimeSlot.startTime,
      endTime: selectedTimeSlot.endTime,
      agreementFileName: agreementFile.name, // Keep for context to know original name
    };

    try {
      // Pass core data and the file object to the context's addBooking function
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                  {availableTimeSlots.map(slot => {
                    ...
                    <Button
                      ...
                      type="button" // Ensure not to submit form
